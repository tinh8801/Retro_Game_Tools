...
def decode(infile: str, outfile: str, fontpos: int):#Giải nén font
    ...
    romfile.seek(fontpos) #Font ở vị trí 0x3720CC
    data = list()
    byte_count = 0
...
def insert(romname: str, fontname: str):
    ...
    dat = fontfile.read()
    romfile.seek(0x3720CC)
    
    if len(dat) <= 0x2000:
        for i in dat:
            romfile.write(bytes([i]))
        for i in range(0x2000 - len(dat)):
...
def main():
    print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    print(":: Aladdin GBA Font Tool                                                ::")
    print(":: Version: 0.1                                                          ::")
    print(":: Date: 2025.09.01                                                      ::")
    print(":: Tác giả: Huy Thắng                                                    ::")
    print(":: Sử dụng: Aladdin_Font_Tool.py [option] ROM_file                       ::")
    print(":: Ví dụ:                                                                ::")
    print(":: Aladdin_Font_Tool.py -x \"Aladdin (USA).gba\"                           ::")
    print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")

    parser = argparse.ArgumentParser(description="Aladdin GBA Font Tool")
    ...
    if args.insert:
        ...
        decode(args.romname, "aladdin_font.bin", 0x3720CC)
    else:
        print("Thiếu tham số")
        #encode("aladdin_font.bin", "aladdin_font_encode.bin")
        #decode("aladdin_font_encode.bin", "tmp.bin", 0x00)
